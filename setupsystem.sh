...
echo "$PYGUESSDIR/runsets.sh '$(pwd)' '$foundsets' '$LEXICON' '$REFDIR'" > guess.${sysname#isi-sbmt-}.sh
qsub -q isi -l walltime=10:00:00 -l nodes=15:quadcore:ppn=4 guess.${sysname#isi-sbmt-}.sh
