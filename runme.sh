...
for w1 in $(seq 0.0 0.05 1.0); do
  for w2 in $(seq 0.0 0.05 1.0); do
    ...
    echo "    python3 thirdeye.py data/{mud.oovlist,mud.oovlist.catmorf,lexicon.norm,mudeval.unique_nes.r1,mud.oovlist.trans_none,train.target.agile,leidos_unigrams,mud.oovlist.fullmorfmatches,out/mud.oovlist.trans_thirdeye_phrase_against_none_lengthratio_\${w1}_\${w2}} 1.0 0.9 1.0 0.5 0.4 0.6 \$w1 \$w2;" >> _r_${w1}_${w2}.sh
